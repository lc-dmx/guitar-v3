...
var treeMenu = [
	{ level:1, name:"吉他管理"},
	{ level:2, name:"吉他列表", ico:"images/icon_default.gif",link:"Guitars_query.action"},
	{ level:2, name:"新增吉他", ico:"images/icon_default.gif",link:"addGuitar.jsp"},
	{ level:2, name:"删除吉他", ico:"images/icon_default.gif"},
	{ level:2, name:"修改吉他", ico:"images/icon_default.gif"}
];
</script>
